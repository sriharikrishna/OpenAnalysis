/*! \file
  ...
  \brief Declarations of the AnnotationManager that generates an InterVary.

  \authors Michelle Strout
  \version $Id: ManagerInterVary.hpp,v 1.2 2005/06/10 02:32:03 mstrout Exp $
...
#ifndef ManagerInterVary_H
#define ManagerInterVary_H
...
*/
class ManagerInterVary : private DataFlow::CallGraphDFProblemNew
{ 
public:
  ManagerInterVary(OA_ptr<ActivityIRInterface> _ir);
  ~ManagerInterVary () {}
