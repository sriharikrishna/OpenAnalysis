...
private: // helper functions
  ...
  void insertEdge(SymHandle, SymHandle, EdgeType, CallHandle, ProcHandle, ProcHandle);
  ...
  void findOutgoingNodes(SymHandle, ProcHandle, std::set<SymHandle>&);
  void findIncomingNodes(SymHandle, ProcHandle, std::set<SymHandle>&);
